...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/1.1.101/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AppointmentsApi()
        api_instance.add_entity_to_appointment  # this is an instance of the class Endpoint
        api_instance.add_entity_to_appointment()  # this invokes api_instance.add_entity_to_appointment.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.add_entity_to_appointment.callable or self.callable in this class
