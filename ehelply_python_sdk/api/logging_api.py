...
class LoggingApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_service_logs_endpoint = _Endpoint(
            settings={
                'response_type': ([LoggingDynamo],),
                'auth': [],
    ...
    def get_service_logs(
        ...
        **kwargs
        ...
        >>> thread = api.get_service_logs(service, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['service'] = \
            service
        return self.get_service_logs_endpoint.call_with_http_info(**kwargs)
