...
# body param
SchemaForRequestBodyApplicationJson = BodyVerifyKeySecurityKeysVerifyPost


request_body_body_verify_key_security_keys_verify_post = api_client.RequestBody(
    content={
...
class VerifyKeySecurityKeysVerifyPost(api_client.Api):
    ...
    def verify_key_security_keys_verify_post(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_body_verify_key_security_keys_verify_post.serialize(body, content_type)
