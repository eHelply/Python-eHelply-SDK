...
# body param
SchemaForRequestBodyApplicationJson = BodyGenerateTokenSecurityTokensPost


request_body_body_generate_token_security_tokens_post = api_client.RequestBody(
    content={
...
_method = 'POST'
SchemaFor200ResponseBodyApplicationJson = InlineResponse2006
...
class GenerateTokenSecurityTokensPost(api_client.Api):
    ...
    def generate_token_security_tokens_post(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_body_generate_token_security_tokens_post.serialize(body, content_type)
