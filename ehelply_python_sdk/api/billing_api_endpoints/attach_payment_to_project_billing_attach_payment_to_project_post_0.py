...
# body param
SchemaForRequestBodyApplicationJson = BodyAttachPaymentToProjectBillingAttachPaymentToProjectPost


request_body_body_attach_payment_to_project_billing_attach_payment_to_project_post = api_client.RequestBody(
    content={
...
_path = '/sam/billing/attach_payment_to_project'
_method = 'POST'
...
class AttachPaymentToProjectBillingAttachPaymentToProjectPost0(api_client.Api):
    ...
    def attach_payment_to_project_billing_attach_payment_to_project_post_0(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_body_attach_payment_to_project_billing_attach_payment_to_project_post.serialize(body, content_type)
