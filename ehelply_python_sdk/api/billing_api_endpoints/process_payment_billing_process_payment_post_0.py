...
# body param
SchemaForRequestBodyApplicationJson = BodyProcessPaymentBillingProcessPaymentPost


request_body_body_process_payment_billing_process_payment_post = api_client.RequestBody(
    content={
...
class ProcessPaymentBillingProcessPaymentPost0(api_client.Api):
    ...
    def process_payment_billing_process_payment_post_0(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_body_process_payment_billing_process_payment_post.serialize(body, content_type)
