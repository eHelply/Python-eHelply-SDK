...
class CompaniesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_company_places_companies_company_uuid_delete_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [],
                'endpoint_path': '/places/companies/{company_uuid}',
                'operation_id': 'delete_company_places_companies_company_uuid_delete',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
    ...
    def delete_company_places_companies_company_uuid_delete(
        ...
        **kwargs
        ...
        >>> thread = api.delete_company_places_companies_company_uuid_delete(company_uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['company_uuid'] = \
            company_uuid
        return self.delete_company_places_companies_company_uuid_delete_endpoint.call_with_http_info(**kwargs)
