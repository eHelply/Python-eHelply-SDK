...
class MetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_meta_endpoint = _Endpoint(
            settings={
                'response_type': (CreateMeta200Response,),
                'auth': [],
                'endpoint_path': '/meta/meta/service/{service}/type/{type_name}/entity/{entity_uuid}',
        ...
        self.create_slug_endpoint = _Endpoint(
            settings={
                'response_type': (CreateSlug200Response,),
                'auth': [],
                'endpoint_path': '/meta/slug',
                'operation_id': 'create_slug',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_meta_endpoint = _Endpoint(
            settings={
                'response_type': (DeleteMeta200Response,),
                'auth': [],
        ...
        self.delete_meta_from_parts_endpoint = _Endpoint(
            settings={
                'response_type': (DeleteMeta200Response,),
                'auth': [],
                'endpoint_path': '/meta/meta/service/{service}/type/{type_name}/entity/{entity_uuid}',
                'operation_id': 'delete_meta_from_parts',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_meta_from_parts_endpoint = _Endpoint(
            settings={
                'response_type': (MetaDynamo,),
                'auth': [],
                'endpoint_path': '/meta/meta/service/{service}/type/{type_name}/entity/{entity_uuid}',
                'operation_id': 'get_meta_from_parts',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.touch_meta_endpoint = _Endpoint(
            settings={
                'response_type': (TouchMeta200Response,),
                'auth': [],
                'endpoint_path': '/meta/meta/{meta_uuid}/touch',
        ...
        self.update_meta_endpoint = _Endpoint(
            settings={
                'response_type': (UpdateMeta200Response,),
                'auth': [],
                'endpoint_path': '/meta/meta/{meta_uuid}',
        ...
        self.update_meta_from_parts_endpoint = _Endpoint(
            settings={
                'response_type': (UpdateMeta200Response,),
                'auth': [],
                'endpoint_path': '/meta/meta/service/{service}/type/{type_name}/entity/{entity_uuid}',
                'operation_id': 'update_meta_from_parts',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def create_meta(
        ...
        **kwargs
        ...
        >>> thread = api.create_meta(service, type_name, entity_uuid, meta_create, async_req=True)
        >>> result = thread.get()
    ...
    def create_slug(
        ...
        **kwargs
        ...
        >>> thread = api.create_slug(slugger, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['slugger'] = \
            slugger
        return self.create_slug_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_meta(
        ...
        **kwargs
        ...
        >>> thread = api.delete_meta(meta_uuid, async_req=True)
        >>> result = thread.get()
    ...
    def delete_meta_from_parts(
        ...
        **kwargs
        ...
        >>> thread = api.delete_meta_from_parts(service, type_name, entity_uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['entity_uuid'] = \
            entity_uuid
        return self.delete_meta_from_parts_endpoint.call_with_http_info(**kwargs)
    ...
    def get_meta(
        ...
        **kwargs
        ...
        >>> thread = api.get_meta(meta_uuid, async_req=True)
        >>> result = thread.get()
    ...
    def get_meta_from_parts(
        ...
        **kwargs
        ...
        >>> thread = api.get_meta_from_parts(service, type_name, entity_uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['entity_uuid'] = \
            entity_uuid
        return self.get_meta_from_parts_endpoint.call_with_http_info(**kwargs)
    ...
    def touch_meta(
        ...
        **kwargs
        ...
        >>> thread = api.touch_meta(meta_uuid, async_req=True)
        >>> result = thread.get()
    ...
    def update_meta(
        ...
        **kwargs
        ...
        >>> thread = api.update_meta(meta_uuid, meta_create, async_req=True)
        >>> result = thread.get()
    ...
    def update_meta_from_parts(
        ...
        **kwargs
        ...
        >>> thread = api.update_meta_from_parts(service, type_name, entity_uuid, meta_create, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['meta_create'] = \
            meta_create
        return self.update_meta_from_parts_endpoint.call_with_http_info(**kwargs)
