...
# body param
SchemaForRequestBodyApplicationJson = BodyIgnoreAlarmMonitorServicesServiceStagesStageAlarmsAlarmUuidIgnorePost


request_body_body_ignore_alarm_monitor_services_service_stages_stage_alarms_alarm_uuid_ignore_post = api_client.RequestBody(
    content={
...
class IgnoreAlarmMonitorServicesServiceStagesStageAlarmsAlarmUuidIgnorePost(api_client.Api):
    ...
    def ignore_alarm_monitor_services_service_stages_stage_alarms_alarm_uuid_ignore_post(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_body_ignore_alarm_monitor_services_service_stages_stage_alarms_alarm_uuid_ignore_post.serialize(body, content_type)
