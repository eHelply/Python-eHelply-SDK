...
# body param
SchemaForRequestBodyApplicationJson = BodyTerminateAlarmMonitorServicesServiceStagesStageAlarmsAlarmUuidTerminatePost


request_body_body_terminate_alarm_monitor_services_service_stages_stage_alarms_alarm_uuid_terminate_post = api_client.RequestBody(
    content={
...
class TerminateAlarmMonitorServicesServiceStagesStageAlarmsAlarmUuidTerminatePost(api_client.Api):
    ...
    def terminate_alarm_monitor_services_service_stages_stage_alarms_alarm_uuid_terminate_post(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_body_terminate_alarm_monitor_services_service_stages_stage_alarms_alarm_uuid_terminate_post.serialize(body, content_type)
