...
# body param
SchemaForRequestBodyApplicationJson = BodyRegisterServiceMonitorServicesPost


request_body_body_register_service_monitor_services_post = api_client.RequestBody(
    content={
...
class RegisterServiceMonitorServicesPost(api_client.Api):
    ...
    def register_service_monitor_services_post(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_body_register_service_monitor_services_post.serialize(body, content_type)
