...
# body param
SchemaForRequestBodyApplicationJson = BodyAttachAlarmNoteMonitorServicesServiceStagesStageAlarmsAlarmUuidNotePost


request_body_body_attach_alarm_note_monitor_services_service_stages_stage_alarms_alarm_uuid_note_post = api_client.RequestBody(
    content={
...
class AttachAlarmNoteMonitorServicesServiceStagesStageAlarmsAlarmUuidNotePost(api_client.Api):
    ...
    def attach_alarm_note_monitor_services_service_stages_stage_alarms_alarm_uuid_note_post(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_body_attach_alarm_note_monitor_services_service_stages_stage_alarms_alarm_uuid_note_post.serialize(body, content_type)
