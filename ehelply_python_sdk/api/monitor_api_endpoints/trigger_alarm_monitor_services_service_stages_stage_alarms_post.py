...
# body param
SchemaForRequestBodyApplicationJson = BodyTriggerAlarmMonitorServicesServiceStagesStageAlarmsPost


request_body_body_trigger_alarm_monitor_services_service_stages_stage_alarms_post = api_client.RequestBody(
    content={
...
class TriggerAlarmMonitorServicesServiceStagesStageAlarmsPost(api_client.Api):
    ...
    def trigger_alarm_monitor_services_service_stages_stage_alarms_post(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_body_trigger_alarm_monitor_services_service_stages_stage_alarms_post.serialize(body, content_type)
