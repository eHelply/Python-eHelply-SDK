...
# body param
SchemaForRequestBodyApplicationJson = BodyAssignAlarmMonitorServicesServiceStagesStageAlarmsAlarmUuidAssignPost


request_body_body_assign_alarm_monitor_services_service_stages_stage_alarms_alarm_uuid_assign_post = api_client.RequestBody(
    content={
...
class AssignAlarmMonitorServicesServiceStagesStageAlarmsAlarmUuidAssignPost(api_client.Api):
    ...
    def assign_alarm_monitor_services_service_stages_stage_alarms_alarm_uuid_assign_post(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_body_assign_alarm_monitor_services_service_stages_stage_alarms_alarm_uuid_assign_post.serialize(body, content_type)
