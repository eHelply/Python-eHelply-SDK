...
# body param
SchemaForRequestBodyApplicationJson = BodyAckAlarmMonitorServicesServiceStagesStageAlarmsAlarmUuidAcknowledgePost


request_body_body_ack_alarm_monitor_services_service_stages_stage_alarms_alarm_uuid_acknowledge_post = api_client.RequestBody(
    content={
...
class AckAlarmMonitorServicesServiceStagesStageAlarmsAlarmUuidAcknowledgePost(api_client.Api):
    ...
    def ack_alarm_monitor_services_service_stages_stage_alarms_alarm_uuid_acknowledge_post(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_body_ack_alarm_monitor_services_service_stages_stage_alarms_alarm_uuid_acknowledge_post.serialize(body, content_type)
