...
# body param
SchemaForRequestBodyApplicationJson = BodyAttachAlarmTicketMonitorServicesServiceStagesStageAlarmsAlarmUuidTicketPost


request_body_body_attach_alarm_ticket_monitor_services_service_stages_stage_alarms_alarm_uuid_ticket_post = api_client.RequestBody(
    content={
...
class AttachAlarmTicketMonitorServicesServiceStagesStageAlarmsAlarmUuidTicketPost(api_client.Api):
    ...
    def attach_alarm_ticket_monitor_services_service_stages_stage_alarms_alarm_uuid_ticket_post(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_body_attach_alarm_ticket_monitor_services_service_stages_stage_alarms_alarm_uuid_ticket_post.serialize(body, content_type)
