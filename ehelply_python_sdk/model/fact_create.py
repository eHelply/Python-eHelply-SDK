...
class FactCreate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, data, public, *args, **kwargs):  # noqa: E501
        """FactCreate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, data, public, *args, **kwargs):  # noqa: E501
        """FactCreate - a model defined in OpenAPI
