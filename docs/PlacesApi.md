...
with ehelply_python_sdk.ApiClient() as api_client:
    ...
    try:
        # Advancedsearchplaces
        api_response = api_instance.advanced_search_places(search_string=search_string, page=page, page_size=page_size, sort_on=sort_on, sort_desc=sort_desc, x_access_token=x_access_token, x_secret_token=x_secret_token, authorization=authorization, ehelply_active_participant=ehelply_active_participant, ehelply_project=ehelply_project, ehelply_data=ehelply_data)
        pprint(api_response)
...
with ehelply_python_sdk.ApiClient() as api_client:
    ...
    try:
        # Deleteplace
        api_response = api_instance.delete_place(place_uuid)
        pprint(api_response)
    except ehelply_python_sdk.ApiException as e:
    ...
    try:
        # Deleteplace
        api_response = api_instance.delete_place(place_uuid, soft_delete=soft_delete, x_access_token=x_access_token, x_secret_token=x_secret_token, authorization=authorization, ehelply_active_participant=ehelply_active_participant, ehelply_project=ehelply_project, ehelply_data=ehelply_data)
        pprint(api_response)
    except ehelply_python_sdk.ApiException as e:
        print("Exception when calling PlacesApi->delete_place: %s\n" % e)
```
...
with ehelply_python_sdk.ApiClient() as api_client:
    ...
    try:
        # Getplace
        api_response = api_instance.get_place(place_uuid)
        pprint(api_response)
    except ehelply_python_sdk.ApiException as e:
...
# **update_place**
> PlaceResponse update_place(place_uuid, place_base)
...
with ehelply_python_sdk.ApiClient() as api_client:
    ...
    try:
        # Updateplace
        api_response = api_instance.update_place(place_uuid, place_base)
        pprint(api_response)
    except ehelply_python_sdk.ApiException as e:
    ...
    try:
        # Updateplace
        api_response = api_instance.update_place(place_uuid, place_base, x_access_token=x_access_token, x_secret_token=x_secret_token, authorization=authorization, ehelply_active_participant=ehelply_active_participant, ehelply_project=ehelply_project, ehelply_data=ehelply_data)
        pprint(api_response)
    except ehelply_python_sdk.ApiException as e:
        print("Exception when calling PlacesApi->update_place: %s\n" % e)
```
